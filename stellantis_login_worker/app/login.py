...
This is a verbatim copy of stellantis_vehicles/app/oauth_browser/login.py
minus its diagnostics CLI (which needs that add-on's Home Assistant shims).
Keep both copies in sync when the Stellantis login flow changes.
"""
import asyncio
import logging
import os
